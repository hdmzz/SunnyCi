...
class	View extends THREE.EventDispatcher {
	...
	constructor( container: HTMLDivElement, center: [lat: number, lon: number] ) {
		...
		this.scene.background = new THREE.CubeTextureLoader().setPath('/dist/').load(['px.png', 'nx.png', 'py.png', 'ny.png', 'pz.png', 'nz.png'])
	...
	private	initSun() {
		...
		this.sunLight.shadow.mapSize.height = 3000;
		this.sunLight.shadow.mapSize.width = 3000;
