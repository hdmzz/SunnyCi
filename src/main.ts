...
async function loadTerrain() {
	...
	//!pas ouf chaque tuiles est fetch independamment l'une de l'autre mais arrive ici et est accumuléedans terrain
	//!Test de lancer la recuperation, decodage, et ajout x
